...
<div class="container mt-5 my-5">
    <center><h2>REGISTERED STUDENT</h2></center>
    <?php
    ...
    <table class="table table-bordered mt-3" style="text-align: center;">
      ...
      ?>
        <tr>
            ...
            <td>
            <button type="button" class="btn btn-success"><a style="text-decoration: none; color: white;" href='edit-reg.php?id=<?php echo $row['id']; ?>'>Edit</a>
            <button type="button" class="btn btn-danger"><a style="text-decoration: none; color: white;" href='delete-reg.php?id=<?php echo $row['id']; ?>'>Delete</a>
