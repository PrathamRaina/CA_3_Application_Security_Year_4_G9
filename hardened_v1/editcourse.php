...
<section class="vh-100" style="background-color: #cccc;">
    <div class="container h-100">
      <div class="row d-flex justify-content-center align-items-center h-100">
        <div class="col-xl-9">
          ...
          <h1 class="text-white mb-4">UPDATE COURSE</h1>
          <?php
    ...
    $sql = "SELECT * FROM courseadd WHERE id = {$stu_id}";
            ...
            <div class="card-body">
              ...
              <div class="row align-items-center pt-4 pb-3">
                ...
                <input type="hidden" name="Id" class="form-control form-control-lg" value="<?php echo $row['Id']; ?>" />
                  <input type="text" name="course" class="form-control form-control-lg" value="<?php echo $row['course']; ?>" />
   ...
   -->
              <div class="row align-items-center py-3">
                ...
                <div class="col-md-9 pe-5">
                  ...
                  <input type="text" name="semester" class="form-control form-control-lg"  value="<?php echo $row['semester']; ?>"/ required>
