...
<div class="container mt-5 my-5">
    <center><h2>Manage Blog Details</h2></center>
    <?php
    ...
    <table class="table table-bordered mt-3" style="text-align: center;">
      <thead>
        <tr>
          ...
          <th style="background-color: #333; color: #fff;"> Name</th>
          <th style="background-color: #333; color: #fff;">Email Id</th>
          <th style="background-color: #333; color: #fff;">Comment</th>
      ...
      ?>
        <tr>
            ...
            <!-- FIX: Escape HTML special characters to prevent XSS :Fixed the Stored XSS Vulnerability v4 here -->
            <td><?php echo htmlspecialchars($row['comment']); ?></td> 

            
            <td>
            <button type="button" class="btn btn-success"><a style="text-decoration: none; color: white;" href='edit-blog.php?id=<?php echo $row['Id']; ?>'>Edit</a>
            <button type="button" class="btn btn-danger"><a style="text-decoration: none; color: white;" href='delete-blog.php?id=<?php echo $row['Id']; ?>'>Delete</a>
