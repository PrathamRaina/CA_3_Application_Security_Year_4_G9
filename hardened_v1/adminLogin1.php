                    ...
                    <div class="card-body p-4 p-lg-5 text-black">
                      ...
                      <form action="" method="post">
                        ...
                        <div class="form-outline mb-4">
                          <input type="text" id="form2Example17" name="t1" class="form-control form-control-lg" />
                          <label class="form-label"  for="form2Example17">User Name</label>
                        </div>
      
                        <div class="form-outline mb-4">
                          <input type="password" id="form2Example27" name="t2" class="form-control form-control-lg" />
                          <label class="form-label" for="form2Example27">Password</label>
                        </div>
      
                        <div class="pt-1 mb-4">
                          <button class="btn btn-dark btn-lg btn-block" type="submit" name="s1">LOGIN</button>
                        </div>
  ...
  if($connection)
{
        ...
        $result = mysqli_query($connection, "SELECT * FROM logintable WHERE username='$useremail' LIMIT 1");  // get only the admin record for this username
  ...
  while($row = mysqli_fetch_assoc($result)) {
      ...
      if (password_verify($userpass, $row["password"])) // verify submitted password against hashed value in DB
    {$i=1;
